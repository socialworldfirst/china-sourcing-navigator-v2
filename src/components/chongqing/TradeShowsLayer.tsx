...
const tradeShows = [
  { month: "SEP", startDay: "19", endDay: "22", name: "CIMAMotor — China International Motorcycle Trade Exhibition", focus: "24th edition. China's premier motorcycle show. Essential for motorcycle sourcing." },
];

export default function TradeShowsLayer() {
  return (
    <div className="space-y-8">
      {/* ── Chongqing Trade Shows ── */}
      <div>
        <h4 className="text-lg font-semibold text-wf-text mb-2">Chongqing trade shows 2026</h4>
        <p className="text-sm text-wf-text-muted mb-4">Chongqing International Expo Center</p>
      ...
      <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h5 className="text-sm font-semibold text-wf-text mb-1">Canton Fair (Guangzhou) &amp; Chengdu &mdash; combine your trip</h5>
            <p className="text-sm text-wf-text-secondary leading-relaxed">
              Canton Fair covers motorcycles, auto parts, and food — all Chongqing-relevant categories.
              Chengdu is just 1 hour from Chongqing by HSR, offering complementary sourcing opportunities.
              Many importers combine Chongqing + Chengdu + a Canton Fair visit in one trip.
            </p>
            <a
