...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Chongqing",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows in Chongqing",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Chongqing",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Chongqing
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Chongqing suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Chongqing&apos;s strongest 1688 categories are motorcycles and auto parts — these are
                      genuine manufacturing categories with direct factory access. For laptops, the factories
                      are closed-ecosystem OEM, but the accessories and peripherals supply chain is accessible.
                      Hotpot products are an emerging export category worth exploring.
                    </p>
