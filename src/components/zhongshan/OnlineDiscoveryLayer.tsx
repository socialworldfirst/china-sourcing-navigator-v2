...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find ZS Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Zhongshan suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use Chinese product names plus the town. Examples: 古镇灯饰 (Guzhen lighting), 中山LED灯具 (Zhongshan LED), 小榄锁具 (Xiaolan locks). WorldFirst’s AI Sourcing Agent translates for you." },
              { step: "2", title: "Filter by Zhongshan", desc: "Set the supplier location filter to 中山 (Zhongshan) or 广东 (Guangdong) province. Many Guzhen suppliers list their showroom address in their 1688 store description." },
              { step: "3", title: "Check factory badges", desc: "Look for 实力商家 (verified merchant) and 源头工厂 (source factory) tags. For lighting, verify they list production capabilities — not just trading." },
              { step: "4", title: "Verify before paying", desc: "Cross-check the business registration at gsxt.gov.cn. Guzhen and Henglan addresses indicate lighting factories. Pay through 1688 World Pay for protection." },
            ].map((s) => (
