...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets for outdoor gear",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows for outdoor equipment",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified outdoor suppliers",
    icon: (
...
export default function SourcingLayersTabs() {
  ...
  return (
    <section id="source-outdoor" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
        {/* Section header */}
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to source <span className="accent-word">outdoor gear</span> from China
        </h2>
        <p className="text-wf-text-secondary mb-10 max-w-2xl hidden md:block">
          Four ways to find outdoor equipment suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      ...
                      trade with each other. For outdoor gear, that means factory-gate pricing on
                      tents, camping furniture, sleeping bags, and outdoor accessories that Alibaba.com
                      doesn&apos;t surface. Filter by &#23425;&#27874; (Ningbo) for tents or
                      &#20315;&#23665; (Foshan) for outdoor furniture.
                    </p>
