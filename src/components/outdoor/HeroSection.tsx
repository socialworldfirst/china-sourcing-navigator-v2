...
/* ── 10 cities ranked for outdoor & camping gear sourcing ── */
const outdoorCities = [
  ...
  { name: "Xiamen",     slug: "xiamen",     stars: 3, imageUrl: `${basePath}/images/xiamen.jpg` },
...
function OutdoorCityCard({ name, slug, stars, imageUrl }: typeof outdoorCities[number]) {
  return (
  ...
  return (
    <section className="relative min-h-[420px] md:min-h-[480px] flex items-end overflow-hidden">
      <img
        ...
        alt="Camping tents pitched beside a lake at golden hour"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-28 w-full">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-semibold leading-[1.1] text-white mb-4 tracking-[-0.02em]">
            Source Outdoor &amp; Camping Gear from China
          </h1>
          <p className="text-lg text-white/70 leading-relaxed">
            From Ningbo&apos;s tent factories supplying the world&apos;s top outdoor brands
            to Foshan&apos;s rattan furniture workshops. 48% of global camping equipment,
            city by city.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            >
              Find outdoor gear suppliers in China
            </a>
          </div>
        </div>
      </div>
...
export { CityCarousel as OutdoorCityCarousel };
