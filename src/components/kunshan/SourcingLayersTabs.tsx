...
const sections = [
  ...
  {
    id: "markets",
    label: "Industrial zones in Kunshan",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows near Kunshan",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Kunshan",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Kunshan
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Kunshan is a factory city, not a market city. Sourcing here means direct factory engagement, 1688 discovery, and trade show connections.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Kunshan&apos;s electronics and precision component manufacturers are active on 1688.
                      Use the 搜工厂 (Search Factory) tab to filter verified manufacturers. Unlike
                      Guangzhou or Yiwu, Kunshan is factory-to-factory &mdash; you won&apos;t find buyer-facing
