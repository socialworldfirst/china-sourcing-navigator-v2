...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Kunshan Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Kunshan suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use Chinese product names plus the city. Examples: 昆山电子 (Kunshan electronics), 昆山PCB (Kunshan PCB), 昆山连接器 (Kunshan connectors), 昆山精密零件 (Kunshan precision parts). WorldFirst’s AI Sourcing Agent translates for you." },
              { step: "2", title: "Filter by Kunshan", desc: "Set the supplier location filter to 昆山 (Kunshan) or 江苏 (Jiangsu) province. Use the 搜工厂 tab to filter for verified factories with production capabilities." },
              { step: "3", title: "Check factory badges", desc: "Look for 实力商家 (verified merchant) and 源头工厂 (source factory) tags. For electronics, check if they list SMT production lines. Verify 经营范围 for 生产 (production) vs 销售 (sales only)." },
              { step: "4", title: "Verify before paying", desc: "Cross-check the business registration at gsxt.gov.cn. KETD zone or Comprehensive Bonded Zone addresses indicate established factories. Pay through 1688 World Pay for protection." },
            ].map((s) => (
