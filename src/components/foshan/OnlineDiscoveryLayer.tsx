...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Foshan Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Foshan suppliers on 1688</h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  <div key={term.cn} className="text-xs">
                    ...
                    <span className="text-wf-text-muted"> &mdash; {term.en}</span>
                  </div>
                ))}
              </div>
            </div>
