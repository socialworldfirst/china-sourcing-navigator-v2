...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Suzhou Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Suzhou suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use the product name in Chinese. Try “苏州丝绸” (Suzhou silk), “盛泽面料” (Shengze fabric), or “苏州精密加工” (Suzhou precision machining)." },
              { step: "2", title: "Filter by Suzhou", desc: "Set the supplier location filter to Suzhou (苏州) or Jiangsu (江苏) province." },
