...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Suzhou",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Suzhou",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Suzhou
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Suzhou suppliers. Most successful importers use multiple approaches at different stages.
        </p>
