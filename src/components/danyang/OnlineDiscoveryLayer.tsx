...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Danyang Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Danyang eyewear suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use Chinese product names. Examples: 丹阳镜片 (Danyang lenses), 丹阳镜架 (Danyang frames), 防蓝光镜片 (anti-blue-light lenses), 树脂镜片 丹阳 (resin lenses Danyang). WorldFirst\u2019s AI Sourcing Agent translates for you." },
              { step: "2", title: "Filter by Danyang", desc: "Set the supplier location filter to 丹阳 (Danyang) or 江苏 (Jiangsu) province. Many Danyang factories also list under 镇江 (Zhenjiang), the parent prefecture." },
              { step: "3", title: "Check factory badges", desc: "Look for 实力商家 (verified merchant) and 源头工厂 (source factory) tags. For eyewear, check if they specify production capabilities: 镜片加工 (lens processing) or 镜架生产 (frame production)." },
              { step: "4", title: "Verify before paying", desc: "Cross-check the business registration. Danyang factories should show a 丹阳 address. Pay through 1688 World Pay for buyer protection." },
            ].map((s) => (
