...
const sections = [
  ...
  {
    id: "markets",
    label: "Eyewear markets in Danyang",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows for Danyang eyewear",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Danyang",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Danyang
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Danyang eyewear suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Danyang has hundreds of eyewear manufacturers on 1688. Search by product type
                      in Chinese &mdash; 丹阳镜片 (Danyang lenses), 丹阳镜架 (Danyang frames) &mdash;
                      and filter by location to find source factories with domestic wholesale pricing.
                    </p>
