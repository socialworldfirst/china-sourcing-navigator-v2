export default function HeroSection() {
  return (
    <section className="relative min-h-[420px] md:min-h-[480px] flex items-end overflow-hidden">
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Chengdu_montage_1.png/800px-Chengdu_montage_1.png"
        alt="Chengdu skyline"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-28 w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-sm md:text-lg text-white/70 leading-relaxed">
            China&apos;s engineering lab. Where R&amp;D meets manufacturing &mdash;
            the western gateway for IT outsourcing, aerospace components, biotech APIs,
            and Sichuan&apos;s iconic food supply chain.
          </p>
