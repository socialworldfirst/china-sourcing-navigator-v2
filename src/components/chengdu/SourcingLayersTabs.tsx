...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Chengdu",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Chengdu",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Chengdu
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Chengdu suppliers. Chengdu is an R&amp;D and services hub, so online platforms and trade shows matter more than wholesale markets here.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Chengdu&apos;s 1688 presence is strongest for food products, seasonings, and general
                      merchandise. For IT outsourcing and biotech, B2B platforms and direct outreach
                      are more effective than 1688.
                    </p>
