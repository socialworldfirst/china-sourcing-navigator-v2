...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Chengdu Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Chengdu suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use Chinese product names. Examples: 四川花椒 (Sichuan peppercorn), 郫县豆瓣酱 (Pixian doubanjiang), 成都食品加工 (Chengdu food processing), 成都调味品 (Chengdu condiments). WorldFirst's AI Sourcing Agent translates for you." },
              { step: "2", title: "Filter by Chengdu", desc: "Set the supplier location filter to 成都 (Chengdu) or 四川 (Sichuan) province. For food products, look for suppliers in Pixian district (郫都区) specifically for doubanjiang." },
              { step: "3", title: "Check factory badges", desc: "Look for 实力商家 (verified merchant) and 源头工厂 (source factory) tags. For food suppliers, check for food production licences (食品生产许可证) and export certifications." },
              { step: "4", title: "Verify before paying", desc: "Cross-check the business registration at gsxt.gov.cn. For IT outsourcing, use LinkedIn and Clutch rather than 1688. Pay through 1688 World Pay for protection on product orders." },
            ].map((s) => (
