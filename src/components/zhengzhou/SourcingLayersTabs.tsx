...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Zhengzhou",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows in Zhengzhou",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Zhengzhou",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Zhengzhou
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Zhengzhou suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Zhengzhou is a logistics and distribution hub, so many 1688 listings are from
                      distributors rather than direct manufacturers. Use the 搜工厂 (Search Factory) tab
                      to filter verified manufacturers, and cross-reference registered addresses to distinguish
                      factories from trading companies.
                    </p>
