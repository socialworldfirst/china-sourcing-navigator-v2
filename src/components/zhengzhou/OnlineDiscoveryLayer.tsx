...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find ZZ Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Zhengzhou suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use Chinese product names. Examples: 郑州电子产品 (electronic products), 郑州食品加工 (food processing), 速冻食品 郑州 (frozen food), 郑州鞋子批发 (shoes wholesale). WorldFirst's AI Sourcing Agent translates for you." },
              { step: "2", title: "Filter by Zhengzhou", desc: "Set the supplier location filter to 郑州 (Zhengzhou) or 河南 (Henan) province. Zhengzhou is a logistics hub — many suppliers here are distributors rather than manufacturers. Check carefully." },
              { step: "3", title: "Check factory badges", desc: "Look for 实力商家 (verified merchant) and 源头工厂 (source factory) tags. For food products, check for 食品生产许可证 (food production licence) and SC certification." },
              { step: "4", title: "Verify before paying", desc: "Cross-check the business registration at gsxt.gov.cn. Verify food safety certifications for any edible products. Pay through 1688 World Pay for protection." },
            ].map((s) => (
