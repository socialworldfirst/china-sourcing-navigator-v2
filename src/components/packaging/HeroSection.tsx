...
/* ── 20 cities rated for packaging sourcing ── */
const packagingCities = [
  ...
  { name: "Dongguan",       slug: "dongguan",     stars: 4, imageUrl: `${basePath}/images/dongguan.webp` },
  { name: "Shanghai",       slug: "shanghai",     stars: 3, imageUrl: `${basePath}/images/shanghai.webp` },
  { name: "Shenzhen",       slug: "shenzhen",     stars: 3, imageUrl: `${basePath}/images/shenzhen.webp` },
  ...
  { name: "Suzhou",         slug: "suzhou",       stars: 2, imageUrl: `${basePath}/images/suzhou.jpg` },
  { name: "Quanzhou",       slug: "quanzhou",     stars: 2, imageUrl: `${basePath}/images/quanzhou.webp` },
  { name: "Xiamen",         slug: "xiamen",       stars: 2, imageUrl: `${basePath}/images/xiamen.webp` },
  ...
  { name: "Danyang",        slug: "danyang",      stars: 1, imageUrl: `${basePath}/images/danyang.webp` },
  { name: "Pingxiang, Hebei", slug: "pingxiang", stars: 1, imageUrl: `${basePath}/images/pingxiang.webp` },
  { name: "Hong Kong",      slug: "hong-kong",    stars: 1, imageUrl: `${basePath}/images/hong-kong.webp` },
];
...
/* ── City card ── */
function PackagingCityCard({ name, slug, stars, imageUrl }: typeof packagingCities[number]) {
  return (
...
export default function HeroSection() {
  return (
    <section className="relative min-h-[420px] md:min-h-[480px] flex items-end overflow-hidden">
      <img
        src="https://images.unsplash.com/photo-1607166452427-7e4477e3890b?w=1600&q=80"
        alt="Custom packaging boxes and printed materials"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-28 w-full">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-semibold leading-[1.1] text-white mb-4 tracking-[-0.02em] lg:whitespace-nowrap">
            Source Packaging from China
          </h1>
          <p className="text-lg text-white/70 leading-relaxed">
            From Yiwu&apos;s wholesale gift box halls to Guangzhou&apos;s custom printing
            factories and Dongguan&apos;s precision die-cutting lines. This is where your
            product&apos;s first impression gets made.
          </p>

          <div className="flex flex-wrap gap-3 mt-6">
            <a
              href="#source-packaging"
              className="btn-pill px-7 py-3 bg-wf-red text-white text-sm font-medium hover:bg-wf-red-hover"
            >
              Find packaging suppliers in China
            </a>
          </div>
        </div>
      </div>
...
export { CityCarousel as PackagingCityCarousel };
