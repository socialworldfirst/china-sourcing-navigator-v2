...
import HeroSection, { HardwareCityCarousel } from "./HeroSection";
import HardwareIntro from "./HardwareIntro";
import HardwareCityAccordion from "./HardwareCityAccordion";
...
export default function HardwarePage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Top hardware & tools sourcing cities — carousel */}
      <section className="py-14 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-2">
              Top <span className="accent-word">hardware &amp; tools</span> sourcing cities
            </h2>
          ...
          <HardwareCityCarousel />
        </div>
      </section>

      <HardwareCityAccordion />
      <SourcingLayersTabs />
