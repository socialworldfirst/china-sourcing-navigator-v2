...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets for hardware & tools",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows for hardware & tools",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified hardware suppliers",
    icon: (
...
export default function SourcingLayersTabs() {
  ...
  return (
    <section id="source-hardware" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
        {/* Section header */}
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to source <span className="accent-word">hardware &amp; tools</span> from China
        </h2>
        <p className="text-wf-text-secondary mb-10 max-w-2xl hidden md:block">
          Four ways to find hardware suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      ...
                      trade with each other. For hardware, that means factory-gate pricing on
                      wrenches, drills, fasteners, and fittings that Alibaba.com
                      doesn&apos;t surface. Filter by &#27704;&#24247; (Yongkang) for power tools or
                      &#23425;&#27874; (Ningbo) for fasteners and hand tools.
                    </p>
