...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Ningbo Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Ningbo suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-4">
            {[
              ...
              { step: "2", title: "Filter by Ningbo", desc: "Set the supplier location filter to Ningbo (宁波), Cixi (慈溪), or Yuyao (余姚) for factory-direct results." },
