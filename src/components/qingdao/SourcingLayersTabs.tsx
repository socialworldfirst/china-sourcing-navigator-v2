...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Qingdao",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Qingdao",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Qingdao
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Qingdao suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Qingdao suppliers are well represented on 1688, especially for tires, eyelashes, and
                      textiles. Search for 青岛轮胎 (Qingdao tires), 平度睫毛 (Pingdu eyelashes), or
                      即墨针织 (Jimo knitwear) to find source factories at domestic wholesale prices.
                    </p>
