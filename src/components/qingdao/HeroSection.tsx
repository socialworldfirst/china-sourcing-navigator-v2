export default function HeroSection() {
  return (
    <section className="relative min-h-[420px] md:min-h-[480px] flex items-end overflow-hidden">
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Qingdao_panorama_2.jpg/1280px-Qingdao_panorama_2.jpg"
        alt="Qingdao coastal skyline"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-28 w-full">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-semibold leading-[1.1] text-white mb-4 tracking-[-0.02em] lg:whitespace-nowrap">
            Sourcing from Qingdao
          </h1>
          <p className="text-sm md:text-lg text-white/70 leading-relaxed">
            Home to Haier and Hisense, China&apos;s tire and rubber capital, and
            the source of 70% of the world&apos;s false eyelashes. The 7th busiest
            container port on earth and northern China&apos;s most underrated
            manufacturing hub.
          </p>
