...
const sections = [
  ...
  {
    id: "tradeshows",
    label: "Trade shows for health and medical",
    icon: (
  ...
  {
    id: "markets",
    label: "Medical device clusters and industrial parks",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified medical suppliers",
    icon: (
...
export default function SourcingLayersTabs() {
  ...
  return (
    <section id="source-health-medical" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
        {/* Section header */}
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to source <span className="accent-word">health and medical</span> products from China
        </h2>
        <p className="text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find medical device and health product suppliers. Regulatory compliance makes due diligence more important here than in any other category.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      ...
                      trade with each other. For medical devices, that means factory-direct pricing
                      on everything from pulse oximeters to rehabilitation equipment, but with an
                      important caveat: always verify NMPA registration and export certifications
                      before ordering.
                    </p>
