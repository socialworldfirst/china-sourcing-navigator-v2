...
/* ── 10 cities ranked for health & medical sourcing ── */
const healthMedicalCities = [
  { name: "Shenzhen",     slug: "shenzhen",     stars: 5, imageUrl: `${basePath}/images/shenzhen.webp` },
  { name: "Shanghai",     slug: "shanghai",      stars: 4, imageUrl: `${basePath}/images/shanghai.webp` },
  ...
  { name: "Dongguan",     slug: "dongguan",      stars: 2, imageUrl: `${basePath}/images/dongguan.webp` },
  { name: "Chengdu",      slug: "chengdu",       stars: 2, imageUrl: `${basePath}/images/chengdu.webp` },
  { name: "Qingdao",      slug: "qingdao",       stars: 1, imageUrl: `${basePath}/images/qingdao.webp` },
];
...
function HealthMedicalCityCard({ name, slug, stars, imageUrl }: typeof healthMedicalCities[number]) {
  return (
  ...
  return (
    <section className="relative min-h-[420px] md:min-h-[480px] flex items-end overflow-hidden">
      <img
        ...
        alt="Medical devices and health monitoring equipment"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-28 w-full">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-semibold leading-[1.1] text-white mb-4 tracking-[-0.02em]">
            Source Health &amp; Medical Products from China
          </h1>
          <p className="text-lg text-white/70 leading-relaxed">
            From Shenzhen&apos;s patient monitors to Shanghai&apos;s pharma valley
            &mdash; China produces a quarter of the world&apos;s medical devices.
            This is where health meets hardware at scale.
          </p>

          <div className="flex flex-wrap gap-3 mt-6">
            <a
              href="#source-health-medical"
              className="btn-pill px-7 py-3 bg-wf-red text-white text-sm font-medium hover:bg-wf-red-hover"
            >
              Find health &amp; medical suppliers in China
            </a>
          </div>
        </div>
      </div>
...
export { CityCarousel as HealthMedicalCityCarousel };
