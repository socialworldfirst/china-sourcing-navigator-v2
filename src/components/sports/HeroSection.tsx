...
/* ── 10 cities ranked for sports equipment sourcing ── */
const sportsCities = [
  { name: "Quanzhou",   slug: "quanzhou",   stars: 5, imageUrl: `${basePath}/images/quanzhou.webp` },
  { name: "Xiamen",     slug: "xiamen",     stars: 4, imageUrl: `${basePath}/images/xiamen.webp` },
  { name: "Ningbo",     slug: "ningbo",     stars: 4, imageUrl: `${basePath}/images/ningbo.webp` },
  ...
  { name: "Yiwu",       slug: "yiwu",       stars: 3, imageUrl: `${basePath}/images/yiwu.webp` },
...
function SportsCityCard({ name, slug, stars, imageUrl }: typeof sportsCities[number]) {
  return (
  ...
  return (
    <section className="relative min-h-[420px] md:min-h-[480px] flex items-end overflow-hidden">
      <img
        ...
        alt="Gym with fitness equipment and free weights"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-28 w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-white/70 leading-relaxed">
            From Jinjiang&apos;s 10 billion sneakers a year to Xiamen&apos;s treadmill factories
            supplying six out of ten homes globally. US$28.4 billion in exports, city by city.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            >
              Find sports equipment suppliers in China
            </a>
          </div>
        </div>
      </div>
...
export { CityCarousel as SportsCityCarousel };
