...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets for sports equipment",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows for sports equipment",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified sports suppliers",
    icon: (
...
export default function SourcingLayersTabs() {
  ...
  return (
    <section id="source-sports" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
        {/* Section header */}
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to source <span className="accent-word">sports equipment</span> from China
        </h2>
        <p className="text-wf-text-secondary mb-10 max-w-2xl hidden md:block">
          Four ways to find sports equipment suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      ...
                      trade with each other. For sports equipment, that means factory-gate pricing on
                      treadmills, dumbbells, yoga mats, and gym machines that Alibaba.com
                      doesn&apos;t surface. Filter by &#21414;&#38376; (Xiamen) for fitness machines or
                      &#38738;&#23707; (Qingdao) for rubber weights.
                    </p>
