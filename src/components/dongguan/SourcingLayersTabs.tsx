...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Dongguan",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Dongguan",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Dongguan
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Dongguan suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      1688 has a dedicated Dongguan Industrial Belt (&#x4E1C;&#x83DE;&#x4EA7;&#x4E1A;&#x5E26;) section. Prices run
                      20-40% below Alibaba.com because there&apos;s no international middleman markup.
                      Many Dongguan factories list lower MOQs on 1688 than on their Alibaba storefronts.
                    </p>
