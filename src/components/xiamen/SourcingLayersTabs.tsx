...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Xiamen",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Xiamen",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Xiamen
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Xiamen suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Xiamen suppliers are active on 1688 across eyewear, fitness equipment, LED lighting,
                      and stone materials. Use Chinese product names and filter by 厦门 (Xiamen) or
                      福建 (Fujian) to find factory-direct pricing 30-50% below international platforms.
                    </p>
