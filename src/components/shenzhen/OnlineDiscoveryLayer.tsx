...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find SZ Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Shenzhen suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use Chinese product names. Examples: \u6DF1\u5733TWS\u8033\u673A (TWS earphones), \u6DF1\u5733PCB\u6253\u6837 (PCB prototyping), \u6DF1\u5733\u5145\u7535\u5B9D (power banks), \u6DF1\u5733\u667A\u80FD\u5BB6\u5C45 (smart home). WorldFirst\u2019s AI Sourcing Agent translates for you." },
              { step: "2", title: "Filter by Shenzhen", desc: "Set the supplier location filter to \u6DF1\u5733 (Shenzhen) or \u5E7F\u4E1C (Guangdong) province. Use \u6DF1\u5733\u4EA7\u4E1A\u5E26 (Shenzhen Industrial Belt) on industry.1688.com for curated manufacturers." },
              { step: "3", title: "Check factory badges", desc: "Look for \u5B9E\u529B\u5546\u5BB6 (verified merchant) and \u6E90\u5934\u5DE5\u5382 (source factory) tags. For electronics, check if they list SMT production lines. Shenzhen has many hybrid companies \u2014 check \u7ECF\u8425\u8303\u56F4 for \u751F\u4EA7 (production) vs \u9500\u552E (sales)." },
              { step: "4", title: "Verify before paying", desc: "Cross-check the business registration at gsxt.gov.cn. Bao\u2019an, Longhua, or Longgang addresses = factories. Futian or Luohu = trading companies. Pay through 1688 World Pay for protection." },
            ].map((s) => (
