...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Shenzhen",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Shenzhen",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Shenzhen
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Shenzhen suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Shenzhen has the densest concentration of electronics manufacturers on 1688.
                      Use the \u641C\u5DE5\u5382 (Search Factory) tab to filter verified manufacturers, and check
                      1688&apos;s electronics sub-marketplaces: ec.1688.com, 3c.1688.com, ee.1688.com, light.1688.com.
                    </p>
