...
const sections = [
  {
    id: "online",
    label: "Search on HKTDC & sourcing platforms",
    icon: (
  ...
  {
    id: "markets",
    label: "Trade centres & showrooms in Hong Kong",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows in Hong Kong",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified partners in Hong Kong",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Partners</span> in Hong Kong
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Hong Kong is a sourcing orchestration hub, not a factory floor. Use these channels to find trading partners, QC firms, and trade show contacts.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Hong Kong sourcing works through HKTDC platforms and trade show connections, not 1688.
                      HKTDC-verified suppliers have passed basic vetting, offering higher trust than cold-contact
                      mainland suppliers.
                    </p>
