...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Shanghai",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Shanghai",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Shanghai
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Shanghai suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Many Shanghai-listed &ldquo;suppliers&rdquo; on 1688 are trading companies aggregating from Zhejiang and
                      Jiangsu factories. That&apos;s not a bad thing — it means you can access the entire Yangtze River Delta
                      supply chain through one platform. Just verify whether you need direct factory access.
                    </p>
