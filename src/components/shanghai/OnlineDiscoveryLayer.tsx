...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Shanghai Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Shanghai suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-4">
            {[
              ...
              { step: "2", title: "Filter by Shanghai", desc: "Set the supplier location filter to Shanghai (上海) or expand to Zhejiang (浙江) and Jiangsu (江苏) for factory access." },
              { step: "3", title: "Check factory vs. trading company", desc: "Look for 源头工厂 (source factory) tags. Many Shanghai listings are trading companies — verify if direct factory matters to you." },
