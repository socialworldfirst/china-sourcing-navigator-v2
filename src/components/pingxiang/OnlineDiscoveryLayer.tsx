...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Pingxiang Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Pingxiang suppliers on 1688</h4>
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left: Steps */}
          <div className="space-y-4">
            {[
              { step: "1", title: "Search in Chinese", desc: "Use Chinese product names. Examples: 平乡童车 (Pingxiang children\u2019s vehicles), 儿童自行车 平乡 (children\u2019s bicycle Pingxiang), 儿童电动车 平乡 (electric ride-on Pingxiang), 婴儿推车 平乡 (baby stroller Pingxiang). WorldFirst\u2019s AI Sourcing Agent translates for you." },
              { step: "2", title: "Filter by Hebei", desc: "Set the supplier location filter to 河北 (Hebei) province or 邢台 (Xingtai) prefecture. Search 河古庙 童车 (Hegumiao children\u2019s vehicles) to target the primary manufacturing township." },
              { step: "3", title: "Check factory badges", desc: "Look for 实力商家 (verified merchant) and 源头工厂 (source factory) tags. Pingxiang has many micro-enterprises \u2014 prioritise suppliers with production photos and export history." },
              { step: "4", title: "Verify before paying", desc: "Cross-check the business registration. A 平乡 or 邢台 address confirms the supplier is in the cluster. Pay through 1688 World Pay for buyer protection." },
            ].map((s) => (
