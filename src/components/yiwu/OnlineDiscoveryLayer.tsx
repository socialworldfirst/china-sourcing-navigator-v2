...
export default function OnlineDiscoveryLayer() {
  ...
  return (
    <div className="space-y-0 px-2 md:px-4">
      {/* ── How to Find Yiwu Suppliers on 1688 + YouTube ── */}
      <div className="py-6">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">How to find Yiwu suppliers on 1688</h4>
      ...
      {/* ── Yiwu-Specific Platforms ── */}
      <div className="py-6 border-t border-wf-border/50">
        <h4 className="text-xl md:text-2xl font-semibold text-wf-text mb-4">Yiwu-specific platforms</h4>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-5 rounded-xl border border-wf-border bg-wf-bg-light">
            ...
            <p className="text-sm text-wf-text-secondary leading-relaxed">
              The official online directory of all 75,000+ International Trade City booths. 4 million+ products listed with booth numbers, photos, and contact details. Use it to plan your visit or identify suppliers before travelling.
            </p>
          </div>
          <div className="p-5 rounded-xl border border-wf-border bg-wf-bg-light">
            <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm text-wf-text-secondary leading-relaxed">
              The newer digital trade platform covering 80,000+ booths. Includes interactive market maps, real-time booth information, and integration with the Global Digital Trade Centre. Yiwu Pay settlement is built in.
            </p>
          </div>
        </div>
      </div>
