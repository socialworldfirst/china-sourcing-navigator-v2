...
import HeroSection, { JewelryCityCarousel } from "./HeroSection";
import JewelryIntro from "./JewelryIntro";
import JewelryCityAccordion from "./JewelryCityAccordion";
...
export default function JewelryPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Top jewelry sourcing cities — carousel */}
      <section className="py-14 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-2">
              Top <span className="accent-word">jewelry &amp; accessories</span> sourcing cities
            </h2>
            <p className="text-wf-text-secondary text-base max-w-lg mx-auto">
              Ranked by supply chain depth, market scale, and export track record
            </p>
          </div>
          <JewelryCityCarousel />
        </div>
