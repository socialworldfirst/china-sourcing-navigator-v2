...
const sections = [
  ...
  {
    id: "markets",
    label: "Jewelry markets and wholesale districts",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified jewelry suppliers",
    icon: (
...
export default function SourcingLayersTabs() {
  ...
  return (
    <section id="source-jewelry" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
        {/* Section header */}
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to source <span className="accent-word">jewelry &amp; accessories</span> from China
        </h2>
        <p className="text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find jewelry suppliers. Fashion jewelry buyers often start on 1688 or in Yiwu; fine jewelry buyers typically visit Panyu or Shuibei directly.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      ...
                      trade with each other. For jewelry, that means factory-direct pricing on fashion
                      accessories from Yiwu, stainless steel pieces from Dongguan, and precious metals
                      from Shenzhen &mdash; all at domestic wholesale prices that Alibaba.com does not show.
                    </p>
