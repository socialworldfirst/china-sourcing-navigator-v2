...
/* ── 20 cities rated for jewelry & accessories sourcing ── */
const jewelryCities = [
  { name: "Yiwu",       slug: "yiwu",       stars: 5, imageUrl: `${basePath}/images/yiwu.webp` },
  { name: "Guangzhou",   slug: "guangzhou",   stars: 4, imageUrl: `${basePath}/images/guangzhou.webp` },
  { name: "Shenzhen",    slug: "shenzhen",    stars: 4, imageUrl: `${basePath}/images/shenzhen.webp` },
  { name: "Dongguan",    slug: "dongguan",    stars: 3, imageUrl: `${basePath}/images/dongguan.webp` },
  { name: "Danyang",     slug: "danyang",     stars: 3, imageUrl: `${basePath}/images/danyang.webp` },
  { name: "Foshan",      slug: "foshan",      stars: 3, imageUrl: `${basePath}/images/foshan.webp` },
  { name: "Hong Kong",   slug: "hong-kong",   stars: 3, imageUrl: `${basePath}/images/hong-kong.webp` },
  { name: "Shanghai",    slug: "shanghai",    stars: 2, imageUrl: `${basePath}/images/shanghai.webp` },
  { name: "Qingdao",     slug: "qingdao",     stars: 2, imageUrl: `${basePath}/images/qingdao.webp` },
  { name: "Hangzhou",    slug: "hangzhou",     stars: 2, imageUrl: `${basePath}/images/hangzhou.jpg` },
  { name: "Ningbo",      slug: "ningbo",      stars: 2, imageUrl: `${basePath}/images/ningbo.webp` },
  { name: "Quanzhou",    slug: "quanzhou",    stars: 1, imageUrl: `${basePath}/images/quanzhou.webp` },
  { name: "Suzhou",      slug: "suzhou",      stars: 1, imageUrl: `${basePath}/images/suzhou.jpg` },
  { name: "Xiamen",      slug: "xiamen",      stars: 1, imageUrl: `${basePath}/images/xiamen.webp` },
  { name: "Zhongshan",   slug: "zhongshan",   stars: 1, imageUrl: `${basePath}/images/zhongshan.webp` },
  { name: "Kunshan",     slug: "kunshan",     stars: 1, imageUrl: `${basePath}/images/kunshan.webp` },
  { name: "Chongqing",   slug: "chongqing",   stars: 1, imageUrl: `${basePath}/images/chongqing.webp` },
  { name: "Zhengzhou",   slug: "zhengzhou",   stars: 1, imageUrl: `${basePath}/images/zhengzhou.webp` },
  { name: "Chengdu",     slug: "chengdu",     stars: 1, imageUrl: `${basePath}/images/chengdu.webp` },
  { name: "Pingxiang, Hebei", slug: "pingxiang", stars: 0, imageUrl: `${basePath}/images/pingxiang.webp` },
];
...
/* ── City card ── */
function JewelryCityCard({ name, slug, stars, imageUrl }: typeof jewelryCities[number]) {
  return (
...
export default function HeroSection() {
  return (
    <section className="relative min-h-[420px] md:min-h-[480px] flex items-end overflow-hidden">
      <img
        src="https://images.unsplash.com/photo-1515562141589-67f0d709e19c?w=1600&q=80"
        alt="Fashion jewelry and accessories display"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-28 w-full">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-semibold leading-[1.1] text-white mb-4 tracking-[-0.02em]">
            Source Jewelry &amp; Accessories from China
          </h1>
          <p className="text-lg text-white/70 leading-relaxed">
            From Yiwu&apos;s 5,000-booth fashion jewelry market to Panyu&apos;s
            fine jewelry workshops and Shuibei&apos;s gold wholesale district.
            Every price point, every material, one supply chain.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            >
              Find jewelry suppliers in China
            </a>
          </div>
        </div>
      </div>
...
export { CityCarousel as JewelryCityCarousel };
