...
const sections = [
  ...
  {
    id: "markets",
    label: "Wholesale markets in Quanzhou",
    icon: (
  ...
  {
    id: "tradeshows",
    label: "Trade shows near Quanzhou",
    icon: (
  ...
  {
    id: "factories",
    label: "WorldFirst verified suppliers in Quanzhou",
    icon: (
    ...
    <section id="find-suppliers" className="py-14 md:py-20 bg-wf-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-wf-text mb-3">
          How to Find <span className="accent-word">Suppliers</span> in Quanzhou
        </h2>
        <p className="hidden md:block text-wf-text-secondary mb-10 max-w-2xl">
          Four ways to find Quanzhou suppliers. Most successful importers use multiple approaches at different stages.
        </p>
                ...
                {section.id === "online" && (
                  <div>
                    <p className="text-sm text-wf-text-secondary leading-relaxed mb-6">
                      Quanzhou&apos;s footwear and apparel factories are heavily represented on 1688.
                      Search for 晋江运动鞋 (Jinjiang sports shoes), 石狮男装 (Shishi menswear), or
                      南安水暖 (Nan&apos;an plumbing) to find source factories at domestic wholesale prices.
                    </p>
